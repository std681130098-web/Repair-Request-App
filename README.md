...
### 👥 ตารางแบ่งหน้าที่ (แก้ไขให้ตรงกับทีมของคุณ)

| สมาชิก | หน้าที่รับผิดชอบ |
|--------|------------------|
| สมาชิก 1 | ออกแบบฐานข้อมูล / Models |
| สมาชิก 2 | ระบบสมาชิก & สิทธิ์ (Auth) |
| สมาชิก 3 | หน้าแจ้งซ่อม & workflow |
| สมาชิก 4 | หน้า UI/UX & Dashboard |
| สมาชิก 5 | รายงาน & การทดสอบ / DevOps |
